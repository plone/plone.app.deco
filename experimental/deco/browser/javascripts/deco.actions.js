                            ...
                            .dialog({
                                ...
                                buttons: {
                                    'Ok': function() {
                                        ...
                                        $.ajax({
                                            type: "PUT",
                                            url: $.deco.options.url,
                                            data: {BODY: $.deco.getPageContent()},
                                            success: function(msg){
                                                ...
                                                $.ajax({
                                                    type: "GET",
                                                    url: $.deco.options.url + "/@@deco-source-content",
                                                ...
                                                $.deco.notify("info", "Info", "Changes saved");
                                            },
                                            error: function(msg){
                                                console.log(msg);
                                            }
                    ...
                    case "revert_changes":
                        ...
                        $.ajax({
                            ...
                            success: function(content) {
                                ...
                                // Notify user
                                $.deco.notify("info", "Info", "Changes reverted");
                            }
                        });
