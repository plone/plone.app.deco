...
xml += """
   <records prefix="plone.app.deco.app_tiles.plone_app_standardtiles_image"
            interface="plone.app.deco.interfaces.ITile">        
        <element key="name">Image</element>
        <element key="label">plone.app.standardtiles.image</element>
        <element key="category">media</element>
        <element key="tile_type">app</element>
        <element key="default_value"></element>
        <element key="read_only">false</element>
        <element key="settings">true</element>
        <element key="favorite">false</element>
        <element key="rich_text">false</element>
    </records>
   ...
   <records prefix="plone.app.deco.app_tiles.plone_app_standardtiles_attachment"
            interface="plone.app.deco.interfaces.ITile">        
        <element key="name">Attachment</element>
        <element key="label">plone.app.standardtiles.attachment</element>
        <element key="category">media</element>
        <element key="tile_type">app</element>
        <element key="default_value"></element>
        <element key="read_only">false</element>
