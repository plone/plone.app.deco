...
parsed_format_data = {'formats': [{'name': u'selection', 'actions': [], 'label': u'Selection'}, {'name': u'actions', 'actions': [], 'label': u'Actions'}, {'name': u'print', 'actions': [], 'label': u'Print'}, {'name': u'text', 'actions': [], 'label': u'Text'}, {'name': u'lists', 'actions': [], 'label': u'Lists'}, {'name': u'justify', 'actions': [], 'label': u'Justify'}]}