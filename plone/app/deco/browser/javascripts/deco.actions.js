...
;(function($) {
    ...
    $.deco.initActions = function() {
        ...
        // Register blur
        $.deco.registerAction('blur', {
            exec: function() {

                // Remove left and right align classes
                var img = $(".deco-selected-tile").children(".deco-tile-content").children("img").get(0);
        ...
        $.deco.registerAction('insert', {
            exec: function(source) {
                ...
                if (tile_config.type == 'app') {
                    ...
                    // Open dialog
                    $.deco.dialog.openIframe($.deco.options.parent + '++addtile++' + $(source).val() +  '?id=random');
